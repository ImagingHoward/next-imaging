const FullPublicationsList = [
  ...
  {
    author:
      "Gong N, Zhang Y, Teng X, Wang Y, Huo S, Qing G, Ni Q, Li X, Wang J, Ye X, Zhang T, Chen S, Wang Y, Yu J, Wang PC, Gan Y, Zhang J, Mitchell MJ, Li J, Liang XJ.",
    title:
  ...
  {
    author:
      "Ignacio DN, Mason KD, Hackett-Morton EC, Albanese C, Ringer L, Wagner WD, Wang PC, Carducci MA, Kachhap SK, Paller CJ, Mendonca J, Li-Ying Chan L, Lin B, Hartle DK, Green JE, Brown CA, Hudson TS. ",
    title:
  ...
  {
    author:
      "Tuguntaev RG, Chen S, Eltahan AS, Mozhi A, Jin S, Zhang J, Li C, Wang PC, Liang XJ.",
    title:
  ...
  {
    author:
      "Zhang T, Guo W, Zhang C, Yu J, Xu J, Li S, Tian JH, Wang PC, Xing JF, Liang XJ.",
    title:
  ...
  {
    author:
      "Zhang C, Zhang T, Jin S, Xue X, Yang X, Gong N, Zhang J, Wang PC, Tian JH, Xing J, Liang XJ.",
    title:
  ...
  },
  {
    ...
    title:
      "Targeting tumor microenvironment with PEG-based amphiphilic nanoparticles to overcome chemoresistance. Nanomedicine.",
  ...
  {
    author:
      "Zhang J, Li S, An FF, Liu J, Jin S, Zhang JC, Wang PC, Zhang X, Lee CS, Liang XJ.",
    title:
  ...
  {
    author:
      "Xue X, Zhao Y, Zhang X, Zhang C, Kumar A, Zhang X, Zou G, Wang PC, Zhang J, Liang XJ.",
    title:
  ...
  {
    author:
      "Li S, Zhang C, Cao W, Ma B, Ma X, Jin S, Zhang J, Wang PC, Li F, Liang XJ.",
    title:
  ...
  {
    author:
      "Hauser B, Zhao Y, Pang X, Ling Z, Myers E, Wang P, Califano J, Gu X.",
    title:
  ...
  {
    author:
      "Huo S, Jin S, Ma X, Xue X, Yang K, Kumar A, Wang PC, Zhang J, Hu Z, Liang XJ.",
    title:
  ...
  {
    author:
      "Barfield WL, Uaesoontrachoon K, Wu CS, Lin S, Chen Y, Wang PC, Kanaan Y, Bond V, Hoffman EP.",
    title:
  ...
  {
    author:
      "Jin SB, Li SL, Wang CX, Liu J, Yang XL, Wang PC, Zhang X, Liang XJ.",
  ...
  {
    author:
      "Li SL, Cao WP, Kumar A, Jin SB, Zhao YY, Zhang CQ, Zou GZ, Wang PC, Li F, Liang XJ.",
    title:
  ...
  {
    author:
      "Kumar A, Chen F, Mozhi A, Zhang X, Zhao YY, Xue XD, Hao YL, Zhang ZN, Wang PC, Liang XJ.",
    title:
  ...
  {
    author:
      "Hu XX, Hao XH, Wu Y, Zhang JC, Zhang XN, Wang PC, Zou GZ, Liang XJ.",
    title:
  ...
  {
    author:
      "Jin SB, Ma XW, Ma HL, Zheng KY, Liu J, Hou SA, Meng J, Wang PC, Wu XC, Liang XL.",
    title:
  ...
  {
    author:
      "Ma XW, Zhang LH, Wang LR, Xue X, Sun JH, Wu Y, Zou GZ, Wu X, Wang PC, Wamer WG, Yin JJ, Zheng KY, Liang XJ.",
    title:
  ...
  {
    author:
      "Huang K, Ma H, Liu J, Huo S, Kumar A, Wei T, Zhang X, Jin S, Gan Y, Wang PC, H S, Zhang X, Liang XJ.",
    title:
      "Size-Dependent Localization and Penetration of Ultrasmall Gold Nano-particles in Cancer Cells, Multicellular Spheroids, and Tumors in Vivo.",
  ...
  {
    author:
      "Xue X, You S, Zhang Q, Wu Y, Zou GZ, Wang PC, Zhao YL, Xu Y, Lee J, Zhang XN, Liang XJ.",
    title:
  ...
  {
    author:
      "Meng J, Xing JM, Wang YZ, Lu J, Zhao YL, Gao XY, Wang PC, Lee J, Liang XJ. ",
    title:
      "Epigenetic Modulation of Human Breast Cancer by Metallofullerene: In Vivo Treatment and In Vitro Analysis. ",
  ...
  },
  {
    ...
    title:
      "Bacterial Magnetosome: a Novel Biogenetic Magnetic Targeted Drug Carrier with Potential Multi-functions.",
  ...
  {
    author:
      "Wang TX, Sridhar R, Korotcov A, Ting AH, Francis K, Mitchell J, Wang PC.",
    title:
  ...
  {
    author:
      "Guo ST, Huang YY, Wei T, Zhang WD, Wang WW, Lin DS, Zhang X, Kumar A, Du Q, Xing JF, Deng LD, Liang ZC, Wang PC, Dong AJ, Liang XJ.",
    title:
  ...
  {
    author:
      "Guo ST, Huang YY, Jiang Q, Sun Y, Deng LD, Liang ZC,  Du Q, Xing JF, Zhao YL, Wang PC, Dong AJ, Liang XJ.",
    title:
  ...
  },
  {
    ...
    title:
      "Biological Effects of  Nanomaterials and Drugs Measured by Small Animal SPECT/CT Imaging System In Vivo.",
    info: "ACTA Biophysica Sinica 26(8):209-215, 2010",
  },
  {
    author:
      "Korotcov A, Shan L, Meng H, Wang TX, Sridhar R, Zhao YL, Liang XJ, Wang PC.",
    title:
  ...
  {
    author:
      "Liang XJ, Chen C, Zhao YL, Wang PC. Circumventing Tumor Resistance to Chemotherapy by Nanotechnology.",
  ...
  {
    author:
      "Hao YB, Xie TP, Korotcov A, Zhou YF, Pang XW, Guo YH, Ji HG, Shan L, Wang PC, Califano J, Xinbin Gu XB. ",
    title:
  ...
  {
    author:
      "Yin JJ, Lao F, Fu PP, Wamer WG, Zhao YL, Wang PC, Han D , Qin Y, Sun BY, Xing GM, Dong JQ, Liang XJ, Chen CY.",
    title:
  ...
  },
  {
    ...
    title:
      "Biopharmaceutics and Therapeutic Potential of Engineered Nanoparticles.",
    info: "Curr Drug Metab. 9(8):697-709, 2008",
  },
  {
    author: "Wang PC, Shan L, Wang SP, Korotcov A, Liang XJ.",
    title:
      "Transferrin Liposome Nanoparticle (TfNIR-LipNBD-Magnevist) – A Tumor Targeting MRI Contrast Agent",
  ...
  {
    author:
      "Yin JJ, Lao F, Meng J, Fu PP, Zhao YL, Xing GM, Gao XY, Sun BY, Wang PC, Chen CY, and Liang XJ.",
    title:
  ...
  {
    author:
      "Liang Shan, Songping Wang, Alexandru Korotcov, Rajagopalan Sridhar, Paul C. Wang.",
    title:
  ...
  {
    author:
      "Ross, S, Ejofodomi O, Jendoubi A, Kinnard L, Chouikha M, Lo B, Wang P, Zheng J. A",
    title:
      "Mammography Database and View System for the African American Patients.",
    info: "J Dig Imaging 21:18-26, 2008",
  },
  {
    author: "Cheng KT, Wang PC, and Shan L. ",
    title:
      "Alexa Fluor 680-labeled Transferrin-cationic (NBD-labeled DOPE-DOTAP) Liposome-encapsulated Gadopentetate Dimeglumine Complex (Abbreviated name: TfNIR-LipNBD-CA complex) Targeting to Transferrin Receptors (TfR).",
  ...
  {
    author:
      "Manaye KF, Wang PC, O'Neil JN, Tizabi Y, Lei D, Xu T, Huang SY, Ottinger MA, Ingram DK, Mouton PR. ",
    title:
  ...
  {
    author:
      "Pirollo K, Dagata J, Wang PC, Freedman M, Vladar A, Fricke S, Ileva L, Zhou Q, Chang EH. A",
    title:
      "Tumor-Targeted Nanodelivery System to Improve Early MRI Detection of Cancer.",
    info: "Molecular Imaging 5(1):41-52, 2006",
  },
  {
    author:
      "Liang XJ, Yin JJ, Zhou JW, Wang PC, Taylor B, Cardarelli C, Kozar M, Forte R, Aszalos A, Gottesman M",
    title:
  ...
  {
    author:
      "Kinnard L, Lo SB, Makariou E, Osicka T, Wang P, Chouikha MF, Freedman MT. ",
    title:
  ...
  },
  {
    ...
    title:
      "Maturity and Temperature Stratification Affects the Germination of Styrax japonicus Seeds",
...
export default FullPublicationsList;